  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 40px rgba(0, 123, 255, 0.5)',
        'glow-success': '0 0 20px rgba(34, 197, 94, 0.4)',
        'glow-warning': '0 0 20px rgba(251, 146, 60, 0.4)',
        'glow-info': '0 0 20px rgba(0, 123, 255, 0.4)',
      },
      backgroundImage: {
        ...
        'gradient-info': 'linear-gradient(135deg, hsl(211 100% 50%), hsl(199 89% 48%))',
        'gradient-accent': 'linear-gradient(135deg, hsl(211 100% 50%), hsl(211 100% 40%))',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(0, 123, 255, 0.4)" },
